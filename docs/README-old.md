...
C.  Define an enumerated data type Degree for the degree programs containing the following data elements SECURITY, NETWORK and SOFTWARE.
...
•   student ID, first name, last name, email address, age , array of number of days to complete each course, & degree types
...
•   SecurityStudent, NetworkStudent, SoftwareStudent
...
5.  Call the destructor to release the Roster memory.
	# C--Class-Roster-Console-Application-Project
